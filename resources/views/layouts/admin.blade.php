...
<body class="animsition">
                ...
                <div class="container-fluid">
                    <div class="header-mobile-inner">
                        <a class="logo" href="index.html">
                            <img src="{{asset('assets/template/images/icon/logo.png')}}" alt="Show Room" />
                        </a>
            ...
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            <a href="{{ url('admin/pembeli') }}">
                                <i class="far fa-check-square"></i>Pembeli</a>
                        </li>
                        <li>
                            ...
                            <div class="header-button">
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        {{-- <div class="image">
                                            <img src="{{asset('assets/template/images/icon/avatar-01.jpg')}}" alt="John Doe" />
                                        </div> --}}
                                        <div class="content">
                                            <a class="js-acc-btn" href="#">Happy Raya</a>
                                        </div>
                                        <div class="account-dropdown js-dropdown">
                                            <div class="info clearfix">
                                                ...
                                                <div class="content">
                                                    ...
                                                    <span class="email">Happraya@gmail.com</span>
                                                </div>
                                            </div>
    ...
    <script src="{{asset('assets/template/vendor/bootstrap-progressbar/bootstrap-progressbar.min.js')}}">
    </script>
