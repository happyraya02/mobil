...
<div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <center>
                        <div class="card-header">Detail paket_kredit</div>
                    </center>
                    ...
                    <div class="card-body">
                        <form action="{{route('paket_kredit.update', $paket_kredit->id)}}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="kode_paket" id="" value="{{$paket_kredit->kode_paket}}"disabled>
                            </div>
                            <div class="form-group">
                                <label for="">Harga Paket</label>
                                <input class="form-control" type="text" name="harga_paket" id="" value="{{$paket_kredit->harga_paket}}"disabled>
                            </div>
                            <div class="form-group">
                                <label for="">Uang Muka</label>
                                <input class="form-control" type="text" name="uang_muka" id="" value="{{$paket_kredit->uang_muka}}"disabled>
                            </div>
                            <div class="form-group">
                                <label for="">Paket Jumlah Cicilan</label>
                                <input class="form-control" type="text" name="jumlah_cicilan" id="" value="{{$paket_kredit->jumlah_cicilan}}"disabled>
                            </div>
                            <div class="form-group">
                                <label for="">Bunga</label>
                                <input class="form-control" type="text" name="bunga" id="" value="{{$paket_kredit->bunga}}"disabled>
                            </div>
                            <div class="form-group">
                                <label for="">Nilai Cicilan</label>
                                <input class="form-control" type="text" name="nilai_cicilan" id="" value="{{$paket_kredit->nilai_cicilan}}"disabled>
                            </div>
                            <div class="form-group">
