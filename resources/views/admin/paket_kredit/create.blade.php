...
<div class="container">
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    <center>
                        <div class="card-header">Tambah paket_kredit</div>
                    </center>
    
                    <div class="card-body">
                        <form action="{{route('paket_kredit.store')}}" method="post">
                            @csrf
                            <div class="form-group">
                                <label for="">kode paket</label>
                                <input class="form-control" type="text" name="kode_paket" >
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="jumlah_cicilan" >
                            </div>
                            <div class="form-group">
                                <label for="">Bunga</label>
                                <input class="form-control" type="text" name="bunga" >
                            </div>
                            <div class="form-group">
                                <label for="">Nilai Cicilan</label>
                                <input class="form-control" type="text" name="nilai_cicilan" >
                            </div>
                            <div class="form-group">
