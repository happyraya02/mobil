                    ...
                    <div class="card-body">
                        <form action="{{route('cash.store')}}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="kode_cash" id="">
                            </div>
                            <div class="form-group">
                                <label for="">KTP</label>
                                <input class="form-control" type="text" name="KTP" id="">
                            </div>
                            <div class="form-group">
                                <label for="">Kode Mobil</label>
                                <input class="form-control" type="text" name="kode_mobil" id="">
                            </div>
                            <div class="form-group">
                                <label for="">Cash Tanggal</label>
                                <input class="form-control" type="text" name="cash_tgl" id="">
                            </div>
                            <div class="form-group">
                                <label for="">Cash Bayar</label>
                                <input class="form-control" type="text" name="cash_bayar" id="">
                            </div>
                            <div class="form-group">
