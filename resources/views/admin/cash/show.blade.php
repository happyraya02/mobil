...
<div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <center>
                        <div class="card-header">Tambah cash</div>
                    </center>
                    ...
                    <div class="card-body">
                        <form action="{{route('cash.update', $cash->id)}}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="kode_cash" id="" value="{{$cash->kode_cash}}"disabled>
                            </div>
                            <div class="form-group">
                                <label for="">KTP</label>
                                <input class="form-control" type="text" name="KTP" id="" value="{{$cash->KTP}}"disabled>
                            </div>
                            <div class="form-group">
                                <label for="">Kode Mobil</label>
                                <input class="form-control" type="text" name="kode_mobil" id="" value="{{$cash->kode_mobil}}"disabled>
                            </div>
                            <div class="form-group">
                                <label for="">Cash Tanggal</label>
                                <input class="form-control" type="text" name="cash_tgl" id="" value="{{$cash->cash_tgl}}"disabled>
                            </div>
                            <div class="form-group">
                                <label for="">Cash Bayar</label>
                                <input class="form-control" type="text" name="cash_bayar" id="" value="{{$cash->cash_bayar}}"disabled>
                            </div>
                            <div class="form-group">
