                    ...
                    <div class="card-body">
                        <form action="{{route('mobil.update', $mobil->id)}}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="kode_mobil" id="" value="{{$mobil->kode_mobil}}"disabled>
                            </div>
                            <div class="form-group">
                                <label for="">Merk</label>
                                <input class="form-control" type="text" name="merk" id="" value="{{$mobil->merk}}"disabled>
                            </div>
                            <div class="form-group">
                                <label for="">Type</label>
                                <input class="form-control" type="text" name="type" id="" value="{{$mobil->type}}"disabled>
                            </div>
                            <div class="form-group">
                                <label for="">Warna</label>
                                <input class="form-control" type="text" name="warna" id="" value="{{$mobil->warna}}"disabled>
                            </div>
                            <div class="form-group">
                                <label for="">Harga Mobil</label>
                                <input class="form-control" type="text" name="harga_mobil" id="" value="{{$mobil->harga_mobil}}"disabled>
                            </div>
                            <div class="card-body">
