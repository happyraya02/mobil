                    ...
                    <div class="card-body">
                        <form action="{{route('pembeli.update', $pembeli->id)}}" method="post">
                            ...
                            <div class="form-group">
                                <label for="">KTP</label>
                                <input class="form-control" type="text" name="KTP" id="" value="{{$pembeli->KTP}}"disabled>
                            </div>
                            <div class="form-group">
                                <label for="">Nama pembeli</label>
                                <input class="form-control" type="text" name="nama_pembeli" id="" value="{{$pembeli->nama_pembeli}}"disabled>
                            </div>
                            <div class="form-group">
                                <label for="">Alamat Pembeli</label>
                                <input class="form-control" type="text" name="alamat_pembeli" id="" value="{{$pembeli->alamat_pembeli}}"disabled>
                            </div>
                            <div class="form-group">
                                <label for="">Telepon Pembeli</label>
                                <input class="form-control" type="text" name="telp_pembeli" id="" value="{{$pembeli->telp_pembeli}}"disabled>
                            </div>
                            <div class="form-group">
