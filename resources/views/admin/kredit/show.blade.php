                    ...
                    <div class="card-body">
                        <form action="{{route('kredit.store')}}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="kode_kredit" id="" value="{{$kredit->kode_kredit}}"disabled>
                            </div>
                            <div class="form-group">
                                <label for="">KTP</label>
                                <input class="form-control" type="text" name="KTP" id="" value="{{$kredit->KTP}}"disabled>
                            </div>
                            <div class="form-group">
                                <label for="">Kode paket</label>
                                <input class="form-control" type="text" name="kode_paket" id="" value="{{$kredit->kode_paket}}"disabled>
                            </div>
                            <div class="form-group">
                                <label for="">kode mobil</label>
                                <input class="form-control" type="text" name="kode_mobil" id="" value="{{$kredit->kode_mobil}}"disabled>
                            </div>
                            <div class="form-group">
                                <label for="">tanggal kredit</label>
                                <input class="form-control" type="text" name="tgl_kredit" id="" value="{{$kredit->tgl_kredit}}"disabled>
                            </div>
                            <div class="form-group">
                                <a href="{{url('admin/kredit')}}" class="btn btn-outline-info">Kembali</a>
                                </div>
                        </form>
                    </div>
                </div>
