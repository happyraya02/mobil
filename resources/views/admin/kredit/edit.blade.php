...
<div class="container">
    ...
    <div class="form-group">
        ...
        <input class="form-control" value="{{ $pembeli->kode_kredit }}" type="text" name="kode_kredit">
    </div>
    <div class="form-group">
        <label for="">KTP</label>
    ...
    <div class="form-group">
        ...
        <input class="form-control" value="{{ $pembeli->kode_paket }}" type="text" name="kode_paket">
    </div>
    <div class="form-group">
        <label for="">kode mobil</label>
        <input class="form-control" value="{{ $pembeli->kode_mobil }}" type="text" name="kode_mobil">
    </div>
    <div class="form-group">
        <label for="">Tanggal Kredit</label>
        <input class="form-control" value="{{ $pembeli->tgl_kredit }}" type="text" name="tgl_kredit">
    </div>
    <div class="form-group">
